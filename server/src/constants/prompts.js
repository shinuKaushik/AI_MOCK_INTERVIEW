...
// ============================================
// All Gemini AI prompt templates used across
// the interview platform.
// Reference: Template literals - reference-javascript.md
// ============================================
...
/**
 * Generate detailed feedback after the interview is complete.
 */
...
/**
 * Evaluate a code submission for a coding question.
 */
...
/**
 * Build conversation history string from messages array.
 * Used to provide context to the AI for follow-up questions.
 */
export const buildConversationHistory = (messages) => {
  ...
  // Reference: Array.slice() - reference-javascript.md
